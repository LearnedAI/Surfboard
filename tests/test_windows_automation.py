...
class TestWindowsAutomation:
    ...
    def test_initialization_windows(self, mock_system):
        ...
        with patch.object(
            WindowsAutomation, "_check_uia_availability", return_value=True
        ):
            automation = WindowsAutomation()
    ...
    async def test_find_windows_by_title_cross_platform(self):
        ...
        with patch.object(
            automation,
            "_find_windows_cross_platform",
            return_value=[WindowInfo(title="Test Chrome Window")],
        ) as mock_find:
    ...
    async def test_focus_window_cross_platform(self):
        ...
        with patch.object(
            automation, "_focus_window_cross_platform", return_value=True
        ) as mock_focus:
    ...
    async def test_get_window_info_found(self):
        ...
        with patch.object(
            automation, "find_windows_by_title", return_value=[test_window]
        ):
...
class TestConvenienceFunctions:
    ...
    async def test_find_chrome_windows(self):
        ...
        with patch(
            "surfboard.automation.windows.WindowsAutomation",
    ...
    async def test_focus_chrome_window_success(self):
        ...
        with patch(
            "surfboard.automation.windows.find_chrome_windows",
            return_value=[chrome_window],
        ):
            mock_automation = AsyncMock()
