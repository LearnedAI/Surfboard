...
from ..protocols.llm_protocol import (
    ...
    PageInfo,
    BrowserInfo,
    ElementSelector as LLMElementSelector,
    create_error_response,
)
from ..automation.browser_manager import BrowserManager, BrowserInstance
from ..actions.core_actions import CoreActions, ElementSelector, ActionError, ElementNotFoundError, TimeoutError
...
class CommandExecutor:
    ...
    async def execute_command(self, command: BaseCommand, session_id: str) -> BaseResponse:
    ...
    async def _get_browser_instance(self, browser_id: Optional[str], session_id: str) -> BrowserInstance:
    ...
    async def _handle_navigate(self, command: BaseCommand, session_id: str) -> BaseResponse:
    ...
    async def _handle_reload(self, command: BaseCommand, session_id: str) -> BaseResponse:
    ...
    async def _handle_go_back(self, command: BaseCommand, session_id: str) -> BaseResponse:
    ...
    async def _handle_go_forward(self, command: BaseCommand, session_id: str) -> BaseResponse:
    ...
    async def _handle_find_element(self, command: BaseCommand, session_id: str) -> FindElementResponse:
        ...
        if command.multiple:
            node_ids = await actions.find_elements(selector, visible_only=command.selector.visible_only)
        else:
            node_id = await actions.find_element(selector, visible_only=command.selector.visible_only)
        ...
        return FindElementResponse(
            ...
            message=f"Found {len(elements)} element(s)" if elements else "No elements found"
        )
        
    async def _handle_find_elements(self, command: BaseCommand, session_id: str) -> FindElementResponse:
    ...
    async def _handle_click(self, command: BaseCommand, session_id: str) -> BaseResponse:
        ...
        success = await actions.click_element(
            ...
            scroll_into_view=command.scroll_into_view
        )
    ...
    async def _handle_type_text(self, command: BaseCommand, session_id: str) -> BaseResponse:
        ...
        return BaseResponse(
            ...
            status=StatusType.SUCCESS if success else StatusType.ERROR,
            execution_time=0.0,
            message=f"Typed text: {command.text[:50]}..." if len(command.text) > 50 else f"Typed text: {command.text}"
        )
        
    async def _handle_clear_text(self, command: BaseCommand, session_id: str) -> BaseResponse:
    ...
    async def _handle_get_text(self, command: BaseCommand, session_id: str) -> TextResponse:
    ...
    async def _handle_get_attribute(self, command: BaseCommand, session_id: str) -> TextResponse:
        ...
        return TextResponse(
            ...
            message=f"Attribute '{command.attribute_name}' retrieved" if value else f"Attribute '{command.attribute_name}' not found"
        )
        
    async def _handle_get_page_title(self, command: BaseCommand, session_id: str) -> TextResponse:
    ...
    async def _handle_get_page_url(self, command: BaseCommand, session_id: str) -> TextResponse:
    ...
    async def _handle_get_page_source(self, command: BaseCommand, session_id: str) -> TextResponse:
        """Handle get page source command."""
        instance = await self._get_browser_instance(command.browser_id, session_id)
        session = await instance.get_cdp_session()
        actions = CoreActions(session)
        
        source = await actions.execute_javascript("return document.documentElement.outerHTML")
    ...
    async def _handle_take_screenshot(self, command: BaseCommand, session_id: str) -> ScreenshotResponse:
    ...
    async def _handle_get_element_screenshot(self, command: BaseCommand, session_id: str) -> ScreenshotResponse:
    ...
    async def _handle_execute_script(self, command: BaseCommand, session_id: str) -> ScriptResponse:
        ...
        result = await actions.execute_javascript(
            command.script,
            await_promise=command.await_promise
        )
    ...
    async def _handle_get_page_summary(self, command: BaseCommand, session_id: str) -> PageSummaryResponse:
    ...
    async def _handle_analyze_elements(self, command: BaseCommand, session_id: str) -> BaseResponse:
    ...
    async def _handle_get_form_data(self, command: BaseCommand, session_id: str) -> BaseResponse:
    ...
    async def _handle_wait_for_element(self, command: BaseCommand, session_id: str) -> FindElementResponse:
    ...
    async def _handle_wait_for_page_load(self, command: BaseCommand, session_id: str) -> BaseResponse:
    ...
    async def _handle_sleep(self, command: BaseCommand, session_id: str) -> BaseResponse:
    ...
    async def _handle_create_browser(self, command: BaseCommand, session_id: str) -> BaseResponse:
        ...
        instance = await self.browser_manager.create_instance(
            ...
            window_size=(config.viewport.width, config.viewport.height) if config.viewport else None,
    ...
    async def _handle_close_browser(self, command: BaseCommand, session_id: str) -> BaseResponse:
    ...
    async def _handle_switch_browser(self, command: BaseCommand, session_id: str) -> BaseResponse:
    ...
    async def _handle_list_browsers(self, command: BaseCommand, session_id: str) -> ListBrowsersResponse:
    ...
    async def _get_element_info(self, actions: CoreActions, node_id: int) -> ElementInfo:
        """Get detailed element information."""
        try:
            # Get element details using JavaScript
            element_data = await actions.execute_javascript(f"""
                (function() {{
